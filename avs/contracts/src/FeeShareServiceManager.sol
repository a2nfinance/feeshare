...
import {IFeeShareServiceManager} from "./IFeeShareServiceManager.sol";
...
/**
 * @title Primary entrypoint for procuring services from FeeShare.
 * @author A2N Finance.
 */
contract FeeShareServiceManager is ECDSAServiceManagerBase, IFeeShareServiceManager {
    ...
    function createNewTask(
        ...
        Task memory newTask = Task({
            ...
            appIds: _appIds,
            fromBlockNum: _fromBlockNum,
            toBlockNum: _toBlockNum,
    ...
    function respondToTask(
        ...
        require(
            block.number <= taskCreatedBlock + MAX_RESPONSE_INTERVAL_BLOCKS,
        ...
        require(
            referenceBlock == taskCreatedBlock,
        ...
        IReward(task.rewardContractAddress).updateReward(taskResponse.appIds, taskResponse.additionalRewards);
    }
