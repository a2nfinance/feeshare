...
library FeeShareDeploymentLib {
    ...
    struct DeploymentData {
        address feeShareServiceManager;
    ...
    function deployContracts(
...

        {
            ...
            result.feeShareServiceManager = UpgradeableProxyLib.setUpEmptyProxy(proxyAdmin);
    ...
    function deployAndUpgradeStakeRegistryImpl(
        ...
        bytes memory upgradeCall = abi.encodeCall(
            ECDSAStakeRegistry.initialize, (deployment.feeShareServiceManager, 0, quorum)
        );
    ...
    function deployAndUpgradeServiceManagerImpl(
        ...
        address feeShareServiceManager = deployment.feeShareServiceManager;
        address feeShareServiceManagerImpl = address(
            new FeeShareServiceManager(
                core.avsDirectory,
        ...
        bytes memory upgradeCall =
            abi.encodeCall(FeeShareServiceManager.initialize, (owner, rewardsInitiator));

        UpgradeableProxyLib.upgradeAndCall(
            feeShareServiceManager, feeShareServiceManagerImpl, upgradeCall
        );
    }
    ...
    function readDeploymentJson(
        ...
        require(vm.exists(fileName), "FeeShareDeployment: Deployment file does not exist");

        string memory json = vm.readFile(fileName);

        DeploymentData memory data;
        /// TODO: 2 Step for reading deployment json.  Read to the core and the AVS data
        data.feeShareServiceManager = json.readAddress(".addresses.feeShareServiceManager");
    ...
    function writeDeploymentJson(
        ...
        writeDeploymentJson("deployments/fee-share/", block.chainid, data);
    }
    ...
    function writeDeploymentJson(
        ...
        address proxyAdmin =
            address(UpgradeableProxyLib.getProxyAdmin(data.feeShareServiceManager));
    ...
    function readDeploymentConfigValues(
        ...
        require(
            vm.exists(pathToFile), "FeeShareDeployment: Deployment Config file does not exist"
        );
    ...
    function _generateContractsJson(
        ...
        return string.concat(
            ...
            data.feeShareServiceManager.toHexString(),
            '","feeShareServiceManagerImpl":"',
            data.feeShareServiceManager.getImplementation().toHexString(),
            '","stakeRegistry":"',
