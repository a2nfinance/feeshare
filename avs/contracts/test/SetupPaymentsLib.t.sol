...
import "../script/utils/FeeShareDeploymentLib.sol";
import "@eigenlayer/contracts/interfaces/IRewardsCoordinator.sol";
import "../src/IFeeShareServiceManager.sol";
...
import "../script/FeeShareDeployer.s.sol";
import {StrategyFactory} from "@eigenlayer/contracts/strategies/StrategyFactory.sol";
import {FeeShareTaskManagerSetup} from "test/FeeShareServiceManager.t.sol";
...
contract SetupDistributionsLibTest is Test, TestConstants, FeeShareTaskManagerSetup {
    using SetupDistributionsLib for *;

    Vm cheats = Vm(VM_ADDRESS);

    IRewardsCoordinator public rewardsCoordinator;
    IFeeShareServiceManager public feeShareServiceManager;
    ...
    function setUp() public virtual override {
        ...
        ECDSAServiceManagerBase(feeShareDeployment.feeShareServiceManager).setRewardsInitiator(
            rewardsInitiator
        );
    ...
    function testCreateAVSRewardsSubmissions() public {
        ...
        mockToken.increaseAllowance(
            feeShareDeployment.feeShareServiceManager, amountPerPayment * numPayments
        );
